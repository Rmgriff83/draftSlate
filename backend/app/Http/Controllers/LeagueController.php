...
class LeagueController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'bench_slots' => ['integer', 'min:1', 'max:7'],
            'sports' => ['required', 'array', 'min:1'],
            'sports.*' => ['string', Rule::in(array_keys(config('draftslate.leagues.supported_sports')))],
            'matchup_duration_days' => ['integer', 'min:1', 'max:7'],
            'draft_time' => ['date_format:H:i:s'],
            'draft_timezone' => ['string', 'max:50'],
            'pick_timer_seconds' => ['integer', 'min:30', 'max:120'],
            'total_matchups' => ['integer', 'min:5', 'max:52'],
            'min_hours_before_game' => ['integer', 'min:1', 'max:72'],
            'season_start_date' => ['nullable', 'date', 'after_or_equal:today'],
    ...
    public function update(Request $request, League $league): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'bench_slots' => ['sometimes', 'integer', 'min:1', 'max:7'],
            'sports' => ['sometimes', 'array', 'min:1'],
            'sports.*' => ['string', Rule::in(array_keys(config('draftslate.leagues.supported_sports')))],
            'matchup_duration_days' => ['sometimes', 'integer', 'min:1', 'max:7'],
            ...
            'total_matchups' => ['sometimes', 'integer', 'min:5', 'max:52'],
            'min_hours_before_game' => ['sometimes', 'integer', 'min:1', 'max:72'],
            'season_start_date' => ['sometimes', 'nullable', 'date', 'after_or_equal:today'],
